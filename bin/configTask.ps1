...
# -------------------------------------------------------------------------
#
# Powershell Script to configure IBM MAS SCADA Historian Connector tasks 
# on Windows Servers. The default install and data roots are:
#
# InstallPath = "C:\ibm\masshc"
# DataPath = "C:\ibm\masshc"
#
# Update the script if install and data root directory location is not as
# specified above.
#
